...
const EditProduct = () => {
  return (
    ...
    <div className='w-screen flex justify-center'>
        ...
        <input value="Diabetes" id="title" type= 'text' name="title" placeholder={'Enter the product title'} className='bg-textFormbg border-textFormBorderbg border-2 outline-none w-full py-2 px-2 rounded-lg' required/>
    </div>
